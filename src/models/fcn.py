"""
FCN implementation using torchvision pre-trained models.
Fully Convolutional Network optimized for IDD semantic segmentation.
"""
...
class FCN(BaseSegmentationModel):
    """
    ...
    - Simpler architecture than DeepLabV3+ but still effective
    """

    def __init__(self, num_classes: int = 7):
        super().__init__(num_classes)

        # Load pre-trained FCN with full model weights
